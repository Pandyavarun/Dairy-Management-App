...
# static fields
.field private static final i:Li0/m$d;
...
.method static constructor <clinit>()V
    ...
    .line 1
    sget-object v0, Li0/m$d;->p:Li0/m$d;

    .line 2
    .line 3
    sput-object v0, Li0/f;->i:Li0/m$d;
...
.method constructor <init>()V
    ...
    .line 3
    .line 4
    sget-object v0, Li0/f;->i:Li0/m$d;

    .line 5
    .line 6
    iput-object v0, p0, Li0/f;->h:Li0/m$d;
...
.method private f()Landroid/util/Size;
    ...
    .line 10
    .line 11
    iget-object v1, p0, Li0/f;->b:Landroid/graphics/Rect;
    ...
    .line 17
    iget-object v2, p0, Li0/f;->b:Landroid/graphics/Rect;
...
.method private l(Landroid/util/Size;I)Landroid/graphics/RectF;
    ...
    .line 7
    .line 8
    invoke-virtual {p0, p1, p2}, Li0/f;->j(Landroid/util/Size;I)Landroid/graphics/Matrix;
    ...
    .line 13
    .line 14
    iget-object v0, p0, Li0/f;->a:Landroid/util/Size;
    ...
    .line 21
    iget-object v1, p0, Li0/f;->a:Landroid/util/Size;
...
.method private m()Z
    ...
    .line 16
    :goto_1
    iget-object v3, p0, Li0/f;->b:Landroid/graphics/Rect;
    ...
    .line 19
    .line 20
    iget-object v3, p0, Li0/f;->a:Landroid/util/Size;
...
.method private static p(Landroid/graphics/Matrix;Landroid/graphics/RectF;Landroid/graphics/RectF;Li0/m$d;)V
    .locals 2

    .line 1
    sget-object v0, Li0/f$a;->a:[I
    ...
    .line 45
    :goto_0
    sget-object v1, Li0/m$d;->s:Li0/m$d;
    ...
    .line 48
    .line 49
    sget-object v1, Li0/m$d;->r:Li0/m$d;
    ...
    .line 52
    .line 53
    sget-object v1, Li0/m$d;->t:Li0/m$d;
...
.method a(Landroid/graphics/Bitmap;Landroid/util/Size;I)Landroid/graphics/Bitmap;
    ...
    .line 8
    :cond_0
    invoke-virtual {p0}, Li0/f;->k()Landroid/graphics/Matrix;
    ...
    .line 12
    invoke-direct {p0, p2, p3}, Li0/f;->l(Landroid/util/Size;I)Landroid/graphics/RectF;
    ...
    .line 61
    iget-object v4, p0, Li0/f;->a:Landroid/util/Size;
...
.method c(Landroid/util/Size;ILandroid/graphics/Rect;)Landroid/graphics/Matrix;
    ...
    .line 13
    .line 14
    invoke-virtual {p0, p1, p2}, Li0/f;->h(Landroid/util/Size;I)Landroid/graphics/Matrix;
...
.method d(Landroid/util/Size;I)Landroid/graphics/RectF;
    ...
    .line 16
    .line 17
    invoke-direct {p0}, Li0/f;->f()Landroid/util/Size;
    ...
    .line 40
    .line 41
    iget-object v3, p0, Li0/f;->h:Li0/m$d;

    .line 42
    .line 43
    invoke-static {v1, v2, v0, v3}, Li0/f;->p(Landroid/graphics/Matrix;Landroid/graphics/RectF;Landroid/graphics/RectF;Li0/m$d;)V
    ...
    .line 60
    invoke-static {v2, p1}, Li0/f;->b(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
...
.method g()Li0/m$d;
    ...
    .line 1
    iget-object v0, p0, Li0/f;->h:Li0/m$d;
...
.method h(Landroid/util/Size;I)Landroid/graphics/Matrix;
    ...
    .line 10
    .line 11
    iget-object v1, p0, Li0/f;->d:Landroid/graphics/Matrix;
...
.method i()Landroid/graphics/Rect;
    ...
    .line 1
    iget-object v0, p0, Li0/f;->b:Landroid/graphics/Rect;
...
.method j(Landroid/util/Size;I)Landroid/graphics/Matrix;
    ...
    .line 7
    .line 8
    invoke-virtual {p0, p1}, Li0/f;->n(Landroid/util/Size;)Z
    ...
    .line 31
    :cond_0
    invoke-virtual {p0, p1, p2}, Li0/f;->d(Landroid/util/Size;I)Landroid/graphics/RectF;
    ...
    .line 43
    .line 44
    invoke-static {p1, p2, v0}, LH/t;->d(Landroid/graphics/RectF;Landroid/graphics/RectF;I)Landroid/graphics/Matrix;
    ...
    .line 67
    .line 68
    iget-object p2, p0, Li0/f;->b:Landroid/graphics/Rect;
...
.method k()Landroid/graphics/Matrix;
    ...
    .line 17
    iget-object v2, p0, Li0/f;->a:Landroid/util/Size;
    ...
    .line 32
    invoke-static {v0, v0, v1}, LH/t;->d(Landroid/graphics/RectF;Landroid/graphics/RectF;I)Landroid/graphics/Matrix;
...
.method n(Landroid/util/Size;)Z
    ...
    .line 7
    invoke-static {p1, v1, v0, v2}, LH/t;->k(Landroid/util/Size;ZLandroid/util/Size;Z)Z
...
.method q(Li0/m$d;)V
    ...
    .line 1
    iput-object p1, p0, Li0/f;->h:Li0/m$d;
...
.method r(LB/C0$h;Landroid/util/Size;Z)V
    .locals 2
    ...
    .line 41
    iput-object v0, p0, Li0/f;->b:Landroid/graphics/Rect;

    .line 42
    .line 43
    invoke-virtual {p1}, LB/C0$h;->b()I
    ...
    .line 53
    iput v0, p0, Li0/f;->e:I

    .line 54
    .line 55
    iput-object p2, p0, Li0/f;->a:Landroid/util/Size;

    .line 56
    .line 57
    iput-boolean p3, p0, Li0/f;->f:Z

    .line 58
    .line 59
    invoke-virtual {p1}, LB/C0$h;->e()Z
    ...
    .line 63
    iput-boolean p2, p0, Li0/f;->g:Z

    .line 64
    .line 65
    invoke-virtual {p1}, LB/C0$h;->c()Landroid/graphics/Matrix;
    ...
    .line 69
    iput-object p1, p0, Li0/f;->d:Landroid/graphics/Matrix;
...
.method s(Landroid/util/Size;ILandroid/view/View;)V
    ...
    :cond_6
    :goto_1
    invoke-direct {p0, p1, p2}, Li0/f;->l(Landroid/util/Size;I)Landroid/graphics/RectF;
