...
.method constructor <init>(Lu/v;ILjava/util/concurrent/Executor;Ljava/util/concurrent/ScheduledExecutorService;Z)V
    .locals 1
    ...
    .line 5
    iput-boolean v0, p0, Lu/e0$h;->c:Z

    .line 6
    .line 7
    iput-object p1, p0, Lu/e0$h;->a:Lu/v;

    .line 8
    .line 9
    iput p2, p0, Lu/e0$h;->b:I

    .line 10
    .line 11
    iput-object p3, p0, Lu/e0$h;->d:Ljava/util/concurrent/Executor;

    .line 12
    .line 13
    iput-object p4, p0, Lu/e0$h;->e:Ljava/util/concurrent/ScheduledExecutorService;

    .line 14
    .line 15
    iput-boolean p5, p0, Lu/e0$h;->f:Z
...
.method public static synthetic d(Lu/e0$h;Ljava/lang/Void;)Lcom/google/common/util/concurrent/q;
    .locals 0

    .line 1
    iget-boolean p1, p0, Lu/e0$h;->f:Z
    ...
    .line 4
    .line 5
    iget-object p0, p0, Lu/e0$h;->a:Lu/v;
...
.method public static synthetic e(Lu/e0$h;Landroidx/concurrent/futures/c$a;)Ljava/lang/Object;
    .locals 1
    ...
    .line 2
    .line 3
    invoke-virtual {p0}, Lu/v;->R()Lu/j2;
    ...
    .line 8
    invoke-virtual {p0, p1, v0}, Lu/j2;->e(Landroidx/concurrent/futures/c$a;Z)V
...
.method public static synthetic h(Lu/e0$h;Ljava/lang/Void;)Lcom/google/common/util/concurrent/q;
    .locals 3

    .line 1
    sget-wide v0, Lu/e0$h;->g:J

    .line 2
    .line 3
    iget-object p1, p0, Lu/e0$h;->e:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public a(Landroid/hardware/camera2/TotalCaptureResult;)Lcom/google/common/util/concurrent/q;
    ...
    .line 36
    .line 37
    iget-object p1, p0, Lu/e0$h;->a:Lu/v;

    .line 38
    .line 39
    invoke-virtual {p1}, Lu/v;->a0()Z
    ...
    .line 57
    iput-boolean p1, p0, Lu/e0$h;->c:Z
    ...
    .line 60
    .line 61
    invoke-direct {p1, p0}, Lu/D0;-><init>(Lu/e0$h;)V
    ...
    .line 73
    .line 74
    invoke-direct {v0, p0}, Lu/E0;-><init>(Lu/e0$h;)V

    .line 75
    .line 76
    .line 77
    iget-object v1, p0, Lu/e0$h;->d:Ljava/util/concurrent/Executor;
    ...
    .line 84
    .line 85
    invoke-direct {v0, p0}, Lu/F0;-><init>(Lu/e0$h;)V
...
.method public c()V
    ...
    .line 1
    iget-boolean v0, p0, Lu/e0$h;->c:Z
    ...
    .line 4
    .line 5
    iget-object v0, p0, Lu/e0$h;->a:Lu/v;

    .line 6
    .line 7
    invoke-virtual {v0}, Lu/v;->R()Lu/j2;
    ...
    .line 13
    invoke-virtual {v0, v1, v2}, Lu/j2;->e(Landroidx/concurrent/futures/c$a;Z)V
    ...
    .line 22
    .line 23
    iget-boolean v0, p0, Lu/e0$h;->f:Z
    ...
    .line 34
    invoke-virtual {v0, v2, v1}, Lu/C1;->o(ZZ)V
