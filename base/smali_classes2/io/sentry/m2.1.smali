...
.method private A(Lio/sentry/Y;Lio/sentry/H;)V
    ...
    .line 1
    invoke-interface {p1}, Lio/sentry/Y;->i()Lio/sentry/j0;
...
.method private C(Lio/sentry/Y;Lio/sentry/H;Lio/sentry/j2;Ljava/lang/String;)Lio/sentry/f4;
    ...
    .line 29
    .line 30
    invoke-interface {p2}, Lio/sentry/h0;->g()Lio/sentry/f4;
...
.method private E(Lio/sentry/V2;Lio/sentry/H;Ljava/util/List;)Lio/sentry/V2;
    ...
    .line 28
    .line 29
    invoke-interface {v0, p1, p2}, Lio/sentry/C;->f(Lio/sentry/V2;Lio/sentry/H;)Lio/sentry/V2;
...
.method private F(Lio/sentry/A3;Lio/sentry/H;Ljava/util/List;)Lio/sentry/A3;
    ...
    .line 17
    :try_start_0
    invoke-interface {v0, p1, p2}, Lio/sentry/C;->c(Lio/sentry/A3;Lio/sentry/H;)Lio/sentry/A3;
...
.method private G(Lio/sentry/protocol/E;Lio/sentry/H;Ljava/util/List;)Lio/sentry/protocol/E;
    ...
    .line 25
    :try_start_0
    invoke-interface {v0, p1, p2}, Lio/sentry/C;->l(Lio/sentry/protocol/E;Lio/sentry/H;)Lio/sentry/protocol/E;
...
.method private I(Lio/sentry/q2;Lio/sentry/H;)Lio/sentry/protocol/x;
    ...
    .line 9
    :try_start_0
    invoke-interface {v0, p1, p2}, Lio/sentry/z3$b;->c(Lio/sentry/q2;Lio/sentry/H;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 43
    .line 44
    invoke-interface {p2, p1}, Lio/sentry/transport/p;->o2(Lio/sentry/q2;)V
    ...
    .line 49
    .line 50
    invoke-interface {v0, p1, p2}, Lio/sentry/transport/p;->l0(Lio/sentry/q2;Lio/sentry/H;)V
...
.method private m(Lio/sentry/Y;Lio/sentry/H;)V
    ...
    .line 2
    .line 3
    invoke-interface {p1}, Lio/sentry/Y;->N()Ljava/util/List;
...
.method private p(Lio/sentry/j2;Lio/sentry/Y;)Lio/sentry/j2;
    ...
    .line 8
    .line 9
    invoke-interface {p2}, Lio/sentry/Y;->j()Lio/sentry/protocol/o;
...
.method private q(Lio/sentry/V2;Lio/sentry/Y;Lio/sentry/H;)Lio/sentry/V2;
    ...
    .line 11
    .line 12
    invoke-interface {p2}, Lio/sentry/Y;->C()Ljava/lang/String;
    ...
    .line 45
    :cond_2
    invoke-interface {p2}, Lio/sentry/Y;->r()Lio/sentry/h0;
    ...
    .line 81
    invoke-interface {v0}, Lio/sentry/h0;->p()Lio/sentry/T3;
    ...
    .line 97
    .line 98
    invoke-interface {p2}, Lio/sentry/Y;->l()Lio/sentry/protocol/g;
    ...
    .line 111
    :cond_5
    invoke-interface {p2}, Lio/sentry/Y;->S()Ljava/util/List;
...
.method M(Lio/sentry/V2;Lio/sentry/H;Lio/sentry/Y;)Lio/sentry/O3;
    ...
    .line 14
    .line 15
    invoke-interface {p3, v0}, Lio/sentry/Y;->t(Lio/sentry/E1$b;)Lio/sentry/O3;
...
.method public a(Lio/sentry/A3;Lio/sentry/Y;Lio/sentry/H;)Lio/sentry/protocol/x;
    ...
    .line 128
    .line 129
    invoke-interface {p2, p1, p3}, Lio/sentry/transport/p;->l0(Lio/sentry/q2;Lio/sentry/H;)V
    :try_end_0
...
.method public c(Lio/sentry/protocol/E;Lio/sentry/f4;Lio/sentry/Y;Lio/sentry/H;Lio/sentry/v1;)Lio/sentry/protocol/x;
    .locals 11
    ...
    .line 146
    .line 147
    invoke-interface {p3}, Lio/sentry/Y;->S()Ljava/util/List;
...
.method public f(Lio/sentry/m3;)V
    .locals 4
...
.method public g(Lio/sentry/q3;)V
    .locals 4
...
.method public h(Lio/sentry/r1;Lio/sentry/Y;)Lio/sentry/protocol/x;
    .locals 5
...
.method public i(Lio/sentry/V2;Lio/sentry/Y;Lio/sentry/H;)Lio/sentry/protocol/x;
    .locals 11
    ...
    .line 236
    .line 237
    invoke-interface {p2, v3}, Lio/sentry/Y;->t(Lio/sentry/E1$b;)Lio/sentry/O3;
    ...
    .line 393
    invoke-interface {v1, v2}, Lio/sentry/z1;->v(Ljava/lang/Boolean;)V
